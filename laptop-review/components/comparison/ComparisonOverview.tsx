    ...
    <>
            ...
            <div key={laptop.id} className="text-center">
              ...
              <div className="flex justify-center space-x-2">
                ...
                <button
                  ...
                  className="inline-block bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-6 rounded"
                >
                  Xóa laptop
                </button>
              </div>
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>Chọn laptop thay thế</DialogTitle>
            <DialogDescription>
                  ...
                  {searchResults.map((laptop) => (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">{laptop.price}</p>
                      </div>
                    </li>
                  ))}
                </ul>
              ) : searchQuery ? (
                <p className="text-center py-4 text-gray-500">Không tìm thấy kết quả phù hợp</p>
              ) : null}
            </div>
          </div>
        </DialogContent>
